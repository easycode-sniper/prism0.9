...
export const RUNTIME_KEYS = new Set<string>([
  ...
  // Tools page: fuel-type tags resolve as t(FUEL_LABEL_KEY[v.fuel]) and
  // driving conditions through a ternary, so neither reaches the scanner
  // as a literal. All six have en + fr entries in the Tools section.
  "Diesel",
  "Petrol",
  "GPL",
  "City",
  "Highway",
  "Mixed",
  // Intelligence conclusion: rendered as t(segment.key, segment.vars)
  // from buildConclusion(), so no call site names these literally.
  "Conclusion improved above limit.",
  "Conclusion improved within limit.",
  "Conclusion stable above limit.",
  "Conclusion stable within limit.",
  "Conclusion worsened above limit.",
  "Conclusion worsened within limit.",
  "Conclusion no baseline.",
  "Conclusion current is.",
  "Conclusion current above limit.",
]);
...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // ── Tools ──
    "Tools": "Tools",
    "Everyday utilities: trip fuel estimates and the transaction spreadsheet cleaner.": "Everyday utilities: trip fuel estimates and the transaction spreadsheet cleaner.",
    "Fuel estimator": "Fuel estimator",
    "Excel transaction processor": "Excel transaction processor",
    "Select vehicle": "Select vehicle",
    "Diesel": "Diesel",
    "Petrol": "Petrol",
    "GPL": "GPL",
    "Enter distance in kilometres": "Enter distance in kilometres",
    "Driving conditions": "Driving conditions",
    "City": "City",
    "Highway": "Highway",
    "Mixed": "Mixed",
    "Trip estimate": "Trip estimate",
    "Fuel needed": "Fuel needed",
    "Total cost": "Total cost",
    "Vehicle": "Vehicle",
    "Consumption": "Consumption",
    "Fuel price": "Fuel price",
    "Estimates use real-world consumption figures. Actual use varies with driving style, load, road conditions, and vehicle state.": "Estimates use real-world consumption figures. Actual use varies with driving style, load, road conditions, and vehicle state.",
    "Click to upload an Excel file (.xlsx or .xls)": "Click to upload an Excel file (.xlsx or .xls)",
    "Process file": "Process file",
    "Processing…": "Processing…",
    "Please upload a valid .xlsx or .xls file": "Please upload a valid .xlsx or .xls file",
    "Could not process that file": "Could not process that file",
    "Done! {count} transactions processed.": "Done! {count} transactions processed.",
    "Preview · first 20 rows": "Preview · first 20 rows",
    "Showing {shown} of {total} transactions": "Showing {shown} of {total} transactions",
    "Download processed file": "Download processed file",
    "Processing steps": "Processing steps",
    "Removes the header row": "Removes the header row",
    "Drops columns C, D, F, J, K — keeps A, B, E, G, H, I": "Drops columns C, D, F, J, K — keeps A, B, E, G, H, I",
    ...
    // main. Added here so the suite is green again.
...
// ── Sign in ──
    ...
    "The whole fleet's budget this month, against what the sheet has already paid.": "The whole fleet's budget this month, against what the sheet has already paid.",
    "Budget": "Budget",
    ...
    "Cancel": "Cancel",
    "Budget for this month, DA": "Budget for this month, DA",
    "A budget must be a positive amount.": "A budget must be a positive amount.",
    ...
    "{n} fills": "{n} fills",
    "Reading the fuel sheet…": "Reading the fuel sheet…",
    ...
    "Models": "Models",
    "No fills match the filters.": "No fills match the filters.",
    "No fills recorded in {month}.": "No fills recorded in {month}.",
    "Model": "Model",
    "Date & Time": "Date & Time",
    "Card No": "Card No",
    "Station": "Station",
    ...
    "Variance (DA)": "Variance (DA)",
    "Showing {from}–{to} of {total}": "Showing {from}–{to} of {total}",
    "Positive means this fill cost more than the assumed rate predicted.": "Positive means this fill cost more than the assumed rate predicted.",
    ...
    "PRISM INTELLIGENCE": "PRISM INTELLIGENCE",
    "STABLE": "STABLE",
    "Watch": "Watch",
    "NO BASELINE": "NO BASELINE",
    "NEW VEHICLE": "NEW VEHICLE",
    "INSUFFICIENT DATA": "INSUFFICIENT DATA",
    "Understand how this vehicle's consumption behavior changes over time.": "Understand how this vehicle's consumption behavior changes over time.",
    "Current consumption": "Current consumption",
    "Previous period": "Previous period",
    "Behavior change": "Behavior change",
    "Close": "Close",
    "Loading fuel history…": "Loading fuel history…",
    "Could not load fuel history.": "Could not load fuel history.",
    "No fills in this window.": "No fills in this window.",
    "Driver assignment": "Driver assignment",
    "Driver assignment unavailable": "Driver assignment unavailable",
    "DRIVER CHANGE": "DRIVER CHANGE",
    "As recorded on fills — assignment between fills is unknown.": "As recorded on fills — assignment between fills is unknown.",
    "Consumption pattern changed following a driver assignment change. Review recommended.": "Consumption pattern changed following a driver assignment change. Review recommended.",
    ...
    "{x} below limit (45 L/100km)": "{x} below limit (45 L/100km)",
    "Consumption trend (L/100km)": "Consumption trend (L/100km)",
    "Reset view": "Reset view",
    "Dots are fills that logged a distance; the dashed amber line is the 45 L/100km normal limit; red spikes exceed the 90 L/100km chart ceiling.": "Dots are fills that logged a distance; the dashed amber line is the 45 L/100km normal limit; red spikes exceed the 90 L/100km chart ceiling.",
    "Consumption summary": "Consumption summary",
    "Previous average": "Previous average",
    "Current average": "Current average",
    "{x} above normal limit": "{x} above normal limit",
    "{x} below normal limit": "{x} below normal limit",
    "Normal limit": "Normal limit",
    "Current": "Current",
    "Extreme observations": "Extreme observations",
    "None in this window.": "None in this window.",
    "{n} above chart scale": "{n} above chart scale",
    "Hover a spike for its real value.": "Hover a spike for its real value.",
    "EXTREME OBSERVATION": "EXTREME OBSERVATION",
    "Chart scale capped at 90 L/100km": "Chart scale capped at 90 L/100km",
    "Chart ceiling": "Chart ceiling",
    "Previous driver:": "Previous driver:",
    "New driver:": "New driver:",
    "Date:": "Date:",
    "Conclusion improved above limit.": "Conclusion improved above limit.",
    "Conclusion improved within limit.": "Conclusion improved within limit.",
    "Conclusion stable above limit.": "Conclusion stable above limit.",
    "Conclusion stable within limit.": "Conclusion stable within limit.",
    "Conclusion worsened above limit.": "Conclusion worsened above limit.",
    "Conclusion worsened within limit.": "Conclusion worsened within limit.",
    "Conclusion no baseline.": "Conclusion no baseline.",
    "Conclusion current is.": "Conclusion current is.",
    "Conclusion current above limit.": "Conclusion current above limit.",
    ...
    // ── Best performing drivers (the star-rated podium) ──
    "Best performing drivers": "Best performing drivers",
    "How the rating is calculated": "How the rating is calculated",
    "The rating measures fuel cost against the {rate} L/100km the sheet assumes. It is not a score for the driver: it says nothing about safety, punctuality or hours, and it does not judge the truck.": "The rating measures fuel cost against the {rate} L/100km the sheet assumes. It is not a score for the driver: it says nothing about safety, punctuality or hours, and it does not judge the truck.",
    "One star per {da} DA of variance per 100km.": "One star per {da} DA of variance per 100km.",
    "at {da} DA saved per 100km or better": "at {da} DA saved per 100km or better",
    "exactly the assumed rate — neither saved nor lost": "exactly the assumed rate — neither saved nor lost",
    "at {da} DA lost per 100km or more": "at {da} DA lost per 100km or more",
    "Ranked on that rate, not on total variance: a driver who barely drives loses almost nothing, and standing still is not a performance.": "Ranked on that rate, not on total variance: a driver who barely drives loses almost nothing, and standing still is not a performance.",
    "Least overspend per 100km, among the drivers who drove far enough to be ranked.": "Least overspend per 100km, among the drivers who drove far enough to be ranked.",
    "Least overspend per 100km, among the {n} drivers who covered at least {km} km in this range.": "Least overspend per 100km, among the {n} drivers who covered at least {km} km in this range.",
    "The full list of every driver is above.": "The full list of every driver is above.",
    "No driver covered enough ground in this range to be ranked.": "No driver covered enough ground in this range to be ranked.",
    "Driver name": "Driver name",
    "Rating": "Rating",
    "Top {shown} of {eligible} drivers who cleared the floor.": "Top {shown} of {eligible} drivers who cleared the floor.",
    // Was raw JSX in the panel and never translated. It now goes through
    // t(), so French finally gets it.
    "Against the sheet's assumed {rate} L/100km. Click a column to sort. A driver with one truck cannot be told apart from it.": "Against the sheet's assumed {rate} L/100km. Click a column to sort. A driver with one truck cannot be told apart from it.",
    // -- Driver variance / fleet intelligence rings (rail) --
    "drivers": "drivers",
    "trucks": "trucks",
    "Driver variance, in bands": "Driver variance, in bands",
    "Where each driver's money landed against the assumed rate. Every driver in this range.": "Where each driver's money landed against the assumed rate. Every driver in this range.",
    "Fleet intelligence, in states": "Fleet intelligence, in states",
    "Every truck against its own previous window. The same words and colours as the table above.": "Every truck against its own previous window. The same words and colours as the table above.",
    "Saving": "Saving",
    ...
    "{saving} of {total} drivers are under the assumed {rate} L/100km.": "{saving} of {total} drivers are under the assumed {rate} L/100km.",
    "{steady} of {total} trucks are steady, {improving} improving.": "{steady} of {total} trucks are steady, {improving} improving.",
  ...
  fr: {
    ...
    // ── Tools ──
    "Tools": "Outils",
    "Everyday utilities: trip fuel estimates and the transaction spreadsheet cleaner.": "Utilitaires du quotidien : estimations de carburant et nettoyage du fichier transactions.",
    "Fuel estimator": "Estimateur carburant",
    "Excel transaction processor": "Retraitement des transactions Excel",
    "Select vehicle": "Choisir le véhicule",
    "Diesel": "Gazole",
    "Petrol": "Essence",
    "GPL": "GPL",
    "Enter distance in kilometres": "Saisissez la distance en kilomètres",
    "Driving conditions": "Conditions de conduite",
    "City": "Ville",
    "Highway": "Autoroute",
    "Mixed": "Mixte",
    "Trip estimate": "Estimation du trajet",
    "Fuel needed": "Carburant nécessaire",
    "Total cost": "Coût total",
    "Vehicle": "Véhicule",
    "Consumption": "Consommation",
    "Fuel price": "Prix du carburant",
    "Estimates use real-world consumption figures. Actual use varies with driving style, load, road conditions, and vehicle state.": "Les estimations reposent sur des consommations réelles. La consommation réelle varie selon le style de conduite, la charge, l'état des routes et l'état du véhicule.",
    "Click to upload an Excel file (.xlsx or .xls)": "Cliquez pour importer un fichier Excel (.xlsx ou .xls)",
    "Process file": "Traiter le fichier",
    "Processing…": "Traitement en cours…",
    "Please upload a valid .xlsx or .xls file": "Veuillez importer un fichier .xlsx ou .xls valide",
    "Could not process that file": "Impossible de traiter ce fichier",
    "Done! {count} transactions processed.": "Terminé ! {count} transactions traitées.",
    "Preview · first 20 rows": "Aperçu · 20 premières lignes",
    "Showing {shown} of {total} transactions": "Affichage de {shown} transactions sur {total}",
    "Download processed file": "Télécharger le fichier traité",
    "Processing steps": "Étapes du traitement",
    "Removes the header row": "Supprime la ligne d'en-tête",
    "Drops columns C, D, F, J, K — keeps A, B, E, G, H, I": "Supprime les colonnes C, D, F, J, K — conserve A, B, E, G, H, I",
...
// ── Sign in ──
    ...
    "Welcome back to": "Content de vous revoir sur",
    ...
    "Fuel budget": "Budget carburant",
    "The whole fleet's budget this month, against what the sheet has already paid.": "Le budget de toute la flotte pour ce mois-ci, comparé à ce que le fichier a déjà payé.",
    "Budget": "Budget",
    ...
    "Cancel": "Annuler",
    "Budget for this month, DA": "Budget du mois en DA",
    "A budget must be a positive amount.": "Le budget doit être un montant positif.",
    ...
    "{n} fills": "{n} pleins",
    "Reading the fuel sheet…": "Lecture de la feuille carburant…",
    "Previous month": "Mois précédent",
    "Next month": "Mois suivant",
    "All drivers": "Tous les chauffeurs",
    "All trucks": "Tous les camions",
    "All models": "Tous les modèles",
    "Models": "Modèles",
    "No fills match the filters.": "Aucun plein ne correspond aux filtres.",
    "No fills recorded in {month}.": "Aucun plein enregistré en {month}.",
    "Model": "Modèle",
    "Date & Time": "Date & heure",
    "Card No": "N° de carte",
    "Station": "Station",
    "Fuel": "Carburant",
    "Amount (DA)": "Montant (DA)",
    "Odometer": "Odomètre",
    "Distance (km)": "Distance (km)",
    "Variance (DA)": "Écart (DA)",
    "Showing {from}–{to} of {total}": "Affichage {from}–{to} sur {total}",
    "Positive means this fill cost more than the assumed rate predicted.": "Positif signifie que ce plein a coûté plus cher que le taux supposé ne le prédisait.",
    ...
    "STABLE": "STABLE",
    "Watch": "À surveiller",
    "NO BASELINE": "PAS DE RÉFÉRENCE",
    "NEW VEHICLE": "NOUVEAU VÉHICULE",
    "INSUFFICIENT DATA": "DONNÉES INSUFFISANTES",
    "Understand how this vehicle's consumption behavior changes over time.": "Comprenez comment la consommation de ce véhicule évolue dans le temps.",
    "Current consumption": "Consommation actuelle",
    "Previous period": "Période précédente",
    "Behavior change": "Évolution du comportement",
    "Close": "Fermer",
    "Loading fuel history…": "Chargement de l'historique carburant…",
    "Could not load fuel history.": "Impossible de charger l'historique carburant.",
    "No fills in this window.": "Aucun plein sur cette période.",
    "Driver assignment": "Affectation chauffeur",
    "Driver assignment unavailable": "Affectation indisponible",
    "DRIVER CHANGE": "CHANGEMENT DE CHAUFFEUR",
    "As recorded on fills — assignment between fills is unknown.": "Tel qu'enregistré sur les pleins — l'affectation entre deux pleins est inconnue.",
    "Consumption pattern changed following a driver assignment change. Review recommended.": "Le profil de consommation a changé après un changement d'affectation. Vérification recommandée.",
    ...
    "{x} below limit (45 L/100km)": "{x} sous la limite (45 L/100km)",
    "Consumption trend (L/100km)": "Tendance de consommation (L/100km)",
    "Reset view": "Réinitialiser la vue",
    "Dots are fills that logged a distance; the dashed amber line is the 45 L/100km normal limit; red spikes exceed the 90 L/100km chart ceiling.": "Les points sont les pleins avec distance ; les pointillés ambre marquent la limite normale de 45 L/100km ; les pics rouges dépassent le plafond de 90 L/100km.",
    "Consumption summary": "Résumé de consommation",
    "Previous average": "Moyenne précédente",
    "Current average": "Moyenne actuelle",
    "{x} above normal limit": "{x} au-dessus de la limite normale",
    "{x} below normal limit": "{x} sous la limite normale",
    "Normal limit": "Limite normale",
    "Current": "Actuel",
    "Extreme observations": "Observations extrêmes",
    "None in this window.": "Aucune sur cette période.",
    "{n} above chart scale": "{n} au-dessus de l'échelle",
    "Hover a spike for its real value.": "Survolez un pic pour sa valeur réelle.",
    "EXTREME OBSERVATION": "OBSERVATION EXTRÊME",
    "Chart scale capped at 90 L/100km": "Échelle plafonnée à 90 L/100km",
    "Chart ceiling": "Plafond du graphique",
    "Previous driver:": "Chauffeur précédent :",
    "New driver:": "Nouveau chauffeur :",
    "Date:": "Date :",
    "Conclusion improved above limit.": "La consommation a baissé de {x} % par rapport à la période précédente, mais reste au-dessus de la limite normale de 45 L/100km.",
    "Conclusion improved within limit.": "La consommation a baissé de {x} % et est désormais sous la limite normale de 45 L/100km.",
    "Conclusion stable above limit.": "La consommation est relativement stable par rapport à la période précédente, mais reste au-dessus de la limite normale de 45 L/100km.",
    "Conclusion stable within limit.": "La consommation est relativement stable par rapport à la période précédente et reste sous la limite normale de 45 L/100km.",
    "Conclusion worsened above limit.": "La consommation a augmenté de {x} % par rapport à la période précédente et reste au-dessus de la limite normale de 45 L/100km.",
    "Conclusion worsened within limit.": "La consommation a augmenté de {x} %, mais reste sous la limite normale de 45 L/100km.",
    "Conclusion no baseline.": "Données historiques insuffisantes pour déterminer un changement de comportement.",
    "Conclusion current is.": "La consommation actuelle est de {x} L/100km.",
    "Conclusion current above limit.": "La consommation actuelle est au-dessus de la limite normale de 45 L/100km.",
    ...
    // ── Meilleurs chauffeurs (le classement étoilé) ──
    "Best performing drivers": "Meilleurs chauffeurs",
    "How the rating is calculated": "Comment la note est calculée",
    "The rating measures fuel cost against the {rate} L/100km the sheet assumes. It is not a score for the driver: it says nothing about safety, punctuality or hours, and it does not judge the truck.": "La note mesure le coût du carburant par rapport aux {rate} L/100 km supposés par la feuille. Ce n'est pas une note du chauffeur : elle ne dit rien de la sécurité, de la ponctualité ni des heures, et elle ne juge pas le camion.",
    "One star per {da} DA of variance per 100km.": "Une étoile pour {da} DA d'écart par 100 km.",
    "at {da} DA saved per 100km or better": "à {da} DA économisés par 100 km ou mieux",
    "exactly the assumed rate — neither saved nor lost": "exactement le taux supposé — ni économie ni perte",
    "at {da} DA lost per 100km or more": "à {da} DA perdus par 100 km ou plus",
    "Ranked on that rate, not on total variance: a driver who barely drives loses almost nothing, and standing still is not a performance.": "Classement sur ce taux, et non sur l'écart total : un chauffeur qui roule peu perd presque rien, et ne pas rouler n'est pas une performance.",
    "Least overspend per 100km, among the drivers who drove far enough to be ranked.": "Sur-dépense la plus faible par 100 km, parmi les chauffeurs ayant assez roulé pour être classés.",
    "Least overspend per 100km, among the {n} drivers who covered at least {km} km in this range.": "Sur-dépense la plus faible par 100 km, parmi les {n} chauffeurs ayant couvert au moins {km} km sur cette période.",
    "The full list of every driver is above.": "La liste complète de tous les chauffeurs se trouve ci-dessus.",
    "No driver covered enough ground in this range to be ranked.": "Aucun chauffeur n'a assez roulé sur cette période pour être classé.",
    "Driver name": "Nom du chauffeur",
    "Rating": "Note",
    "Top {shown} of {eligible} drivers who cleared the floor.": "{shown} meilleurs sur {eligible} chauffeurs ayant franchi le seuil.",
    "Against the sheet's assumed {rate} L/100km. Click a column to sort. A driver with one truck cannot be told apart from it.": "Par rapport aux {rate} L/100 km supposés par la feuille. Cliquez sur une colonne pour trier. Un chauffeur avec un seul camion ne peut pas être distingué de celui-ci.",
    // -- Anneaux de repartition (rail) --
    "drivers": "chauffeurs",
    "trucks": "camions",
    "Driver variance, in bands": "Écart par tranche",
    "Where each driver's money landed against the assumed rate. Every driver in this range.": "Où l'argent de chaque chauffeur s'est situé par rapport au taux supposé. Tous les chauffeurs de la période.",
    "Fleet intelligence, in states": "État de la flotte",
    "Every truck against its own previous window. The same words and colours as the table above.": "Chaque camion par rapport à sa fenêtre précédente. Les mêmes mots et les mêmes couleurs que le tableau ci-dessus.",
    "Saving": "Économise",
    "At the limit": "Au taux",
    "Losing": "Perd",
    "No rate": "Sans taux",
    "Improving": "En amélioration",
    "Steady": "Stable",
    "Worsening": "En dégradation",
    "No verdict": "Sans verdict",
    "{saving} of {total} drivers are under the assumed {rate} L/100km.": "{saving} chauffeur(s) sous les {rate} L/100 km supposés, sur {total}.",
    "{steady} of {total} trucks are steady, {improving} improving.": "{steady} camions stables sur {total}, dont {improving} en amélioration.",
