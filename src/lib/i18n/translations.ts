...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "Every delivery point, who to call and when it is open": "Every delivery point, who to call and when it is open",
    "Search client, site, phone or rep…": "Search client, site, phone or rep…",
    "clients.filter.all": "all",
    "clients.filter.open": "open now",
    "clients.filter.24h": "24/7",
    "clients.filter.friday": "Friday excluded",
    "clients.filter.nophone": "no phone",
    "clients.filter.nosite": "no site",
    "{n} open now": "{n} open now",
    ...
    "Fri excl.": "Fri excl.",
    "No geofenced site for this delivery point yet": "No geofenced site for this delivery point yet",
    ...
    "Live tracking stale": "Live tracking stale",
    "Live tracking down": "Live tracking down",
    "{age} ago": "{age} ago",
    "The fleet feed has not been updated for {age}.": "The fleet feed has not been updated for {age}.",
    ...
    "fills": "fills",
    "{n} vehicles reporting, staff cars included.": "{n} vehicles reporting, staff cars included.",
    ...
    "vs the previous 7 days": "vs the previous 7 days",
    "vs the previous 30 days": "vs the previous 30 days",
    "vs the same days last month": "vs the same days last month",
    ...
    "A stop of more than 25 minutes at a client site. The plant is not a delivery.": "A stop of more than 25 minutes at a client site. The plant is not a delivery.",
    "No site tracking before {day} — those days are a gap, not zero.": "No site tracking before {day} — those days are a gap, not zero.",
    "not tracked yet": "not tracked yet",
    "The scorecards cover the whole range. The charts below show the most recent {days} days of it.": "The scorecards cover the whole range. The charts below show the most recent {days} days of it.",
    ...
    "Fuel by model": "Fuel by model",
    "Cell area is what each model cost at the pump. The model is read from the plate.": "Cell area is what each model cost at the pump. The model is read from the plate.",
    "Fills": "Fills",
    "Amount": "Amount",
    "Share": "Share",
    ...
    "Search a driver or truck…": "Search a driver or truck…",
    "Drivers and trucks": "Drivers and trucks",
    "Loading drivers and trucks…": "Loading drivers and trucks…",
    "Nobody and no truck matches “{q}”": "Nobody and no truck matches “{q}”",
    "Show the whole fleet again": "Show the whole fleet again",
    "Clear": "Clear",
    "Showing driver {name}.": "Showing driver {name}.",
    "Showing truck {name}.": "Showing truck {name}.",
  ...
  fr: {
    ...
    // ── Clients ──
    "clients.title": "Clients",
    "Every delivery point, who to call and when it is open": "Chaque lieu de déchargement, qui appeler et quand il est ouvert",
    "Search client, site, phone or rep…": "Rechercher un client, un lieu, un téléphone ou un commercial…",
    "clients.filter.all": "tous",
    "clients.filter.open": "ouvert",
    "clients.filter.24h": "24/24",
    "clients.filter.friday": "vendredi exclu",
    "clients.filter.nophone": "sans téléphone",
    "clients.filter.nosite": "sans site",
    "{n} open now": "{n} ouverts maintenant",
    "Loading clients": "Chargement des clients",
    "Client": "Client",
    "Delivery point": "Lieu de déchargement",
    "Hours": "Horaires",
    "Phone": "Téléphone",
    "Rep": "Commercial",
    "km": "km",
    ...
    "Fri excl.": "Ven. exclu",
    "No geofenced site for this delivery point yet": "Pas encore de site géolocalisé pour ce lieu",
    ...
    "Live tracking stale": "Suivi en direct obsolète",
    "Live tracking down": "Suivi en direct interrompu",
    "{age} ago": "il y a {age}",
    "The fleet feed has not been updated for {age}.": "Le flux de la flotte n'a pas été mis à jour depuis {age}.",
    ...
    "fills": "pleins",
    "{n} vehicles reporting, staff cars included.": "{n} véhicules connectés, véhicules de service inclus.",
    ...
    "vs the previous 7 days": "vs les 7 jours précédents",
    "vs the previous 30 days": "vs les 30 jours précédents",
    "vs the same days last month": "vs les mêmes jours le mois dernier",
    ...
    "A stop of more than 25 minutes at a client site. The plant is not a delivery.": "Un arrêt de plus de 25 minutes sur un site client. L'usine n'est pas une livraison.",
    "No site tracking before {day} — those days are a gap, not zero.": "Aucun suivi des sites avant le {day} — ces jours sont une absence de données, pas un zéro.",
    "not tracked yet": "non suivi à cette date",
    "The scorecards cover the whole range. The charts below show the most recent {days} days of it.": "Les indicateurs couvrent toute la période. Les graphiques ci-dessous n'en montrent que les {days} derniers jours.",
    ...
    "Fuel by model": "Carburant par modèle",
    "Cell area is what each model cost at the pump. The model is read from the plate.": "La surface de chaque case est le montant payé à la pompe par modèle. Le modèle est déterminé par la plaque.",
    "Fills": "Pleins",
    "Amount": "Montant",
    "Share": "Part",
    ...
    "Search a driver or truck…": "Rechercher un chauffeur ou un camion…",
    "Drivers and trucks": "Chauffeurs et camions",
    "Loading drivers and trucks…": "Chargement des chauffeurs et des camions…",
    "Nobody and no truck matches “{q}”": "Aucun chauffeur ni camion ne correspond à « {q} »",
    "Show the whole fleet again": "Afficher de nouveau toute la flotte",
    "Clear": "Effacer",
    "Showing driver {name}.": "Affichage du chauffeur {name}.",
    "Showing truck {name}.": "Affichage du camion {name}.",
  ...
  ar: {
    ...
    "vs the previous 7 days": "مقارنة بالأيام السبعة السابقة",
    "vs the previous 30 days": "مقارنة بالثلاثين يوماً السابقة",
